        ...
        <div className="bg-background w-[98%] mx-auto p-4 md:px-10 rounded-lg rounded-b-none  h-fit flex flex-col ">
            <div className="max-w-5xl mx-auto">
                ...
                <Markdown remarkPlugins={[remarkGfm]} components={{
                    ...
                    <p className="mt-2 font-maitree  text-foreground md:ml-4  text-lg/relaxed font-extralight">
                        ...
                        <div className="editor-window md:w-full w-[90%] mx-auto overflow-x-clip h-full bg-card rounded-lg shadow-lg my-10">
                            <MorseConverter />
                        </div>
