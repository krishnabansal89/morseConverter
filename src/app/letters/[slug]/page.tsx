        ...
        <div className="hero bg-[rgb(236,232,228)] w-[98%] mx-auto p-4 md:px-10 rounded-lg rounded-b-none  h-fit flex flex-col ">
            <div className="w-full h-fit my-20  grid md:px-10  md:grid-cols-[65%_35%] grid-cols-1 justify-center ">
                <div className="flex  items-center  ">
                    <h1 className="xl:text-5xl/relaxed lg:text-4xl/relaxed  text-3xl/relaxed  font-medium text-[#2d2d2d]  tracking-tight md:px-4 font-poppins">What is {letter} in Morse Code ?   <br></br> Instant<span className="bg-gradient-to-r from-green-500 to-teal-900 text-transparent bg-clip-text"> Meaning, Representation & Uses </span></h1>
                </div>
            ...
            <div className="mt-20">
                ...
                <div className="grid grid-cols-3 max-w-5xl mx-auto gap-y-4 ">
                ...
                <div className="max-w-5xl mx-auto my-10">
                    <Markdown  remarkPlugins={[remarkGfm]} components={{
                        ...
                        br: () => <br />,
                        li: ({ children }) => <li className="text-[#6c6860] list-disc md:ml-10 ml-4 my-2 font-maitree  text-lg/relaxed font-extralight">{children}</li>,
