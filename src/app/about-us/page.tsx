      ...
      <div className="max-w-5xl mx-auto w-full py-8 md:py-12">
        ...
        <div className="text-[#372824]">
          ...
          <ul className="mb-4">
            ...
            <li className="text-[#2d2d2d] list-disc md:ml-10 ml-6 my-2 font-maitree text-lg/relaxed font-extralight">Decode Morse code into plain text</li>
            <li className="text-[#2d2d2d] list-disc md:ml-10 ml-6 my-2 font-maitree text-lg/relaxed font-extralight">Support multiple languages (where applicable)</li>
            <li className="text-[#2d2d2d] list-disc md:ml-10 ml-6 my-2 font-maitree text-lg/relaxed font-extralight">Learn and practice Morse with accuracy and speed</li>
          </ul>

          <h2 className="md:text-2xl/relaxed text-xl/relaxed text-[#2d2d2d] font-medium my-6">What Makes Us Different</h2>
          <ul className="mb-4">
            <li className="text-[#2d2d2d] list-disc md:ml-10 ml-6 my-2 font-maitree text-lg/relaxed font-extralight"><strong>Fast & Easy to Use</strong> – Just type, paste, or tap, and get instant results.</li>
            <li className="text-[#2d2d2d] list-disc md:ml-10 ml-6 my-2 font-maitree text-lg/relaxed font-extralight"><strong>Clean Interface</strong> – No distractions. Just pure functionality.</li>
            <li className="text-[#2d2d2d] list-disc md:ml-10 ml-6 my-2 font-maitree text-lg/relaxed font-extralight"><strong>Free Access</strong> – No login, no fees — just tools that work.</li>
            <li className="text-[#2d2d2d] list-disc md:ml-10 ml-6 my-2 font-maitree text-lg/relaxed font-extralight"><strong>Accurate Translations</strong> – Built with attention to the true structure of Morse code.</li>
          </ul>
