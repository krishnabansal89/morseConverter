...
function Features() {
    ...
    const features = [
        ...
        {
            type: "Продукт",
            title: "Машина кода Морзе",
            description: "Мгновенно преобразуйте набор текста в код Морзе. Скорость Морзе настраивается и может быть звуковыми сигналами, мигающим светом или вибрацией.",
        ...
        {
            type: "Продукт",
            title: "Переводчик Кода Морзе с Аудио",
            description: "Слушайте аудиосигналы кода Морзе для любого текста.",
            href: "/morse-code-translator-audio",
            bgColor: "bg-[#31304D]"
        },
        {
            type: "Продукт",
            title: "Переводчик Кода Морзе с Изображения",
            description: "Загрузите изображение с текстом. Мы выполним OCR в вашем браузере и переведем извлеченный текст в код Морзе. Копируйте, слушайте или загружайте как аудио.",
            href: "/morse-code-translator-picture",
            bgColor: "bg-[#493628]"
        },
        {
            type: "Продукт",
            title: "Ключ и Звуковой генератор кода Морзе",
            description: "Изучите историю, функции и современное использование ключей и звуковых генераторов кода Морзе. Узнайте, как они сформировали коммуникацию, как они работают и их актуальность сегодня в любительском радио, обучении и хобби-проектах",
            href: "/morse-code-keyer",
            bgColor: "bg-[#5D4E37]"
        },
        {
            type: "Продукт",
            title: "Игра с Кодом Морзе",
            description: "Проверьте свои навыки прослушивания с помощью нашей интерактивной игры. Улучшите свою скорость WPM, научитесь декодировать точки и тире, и бросьте себе вызов с адаптивными уровнями сложности.",
