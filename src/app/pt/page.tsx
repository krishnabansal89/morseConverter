    ...
    const features = [
        {
            ...
            description: "Traduza com precisão do português para o código Morse internacional e vice-versa.",
        ...
        },
        {
            ...
            description: "Traduza com precisão do português para o código Morse americano e vice-versa.",
