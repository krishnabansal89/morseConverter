        ...
        <div className="hero bg-background w-[98%] mx-auto p-4 md:px-10 rounded-lg rounded-b-none  h-fit flex flex-col ">
            <div className="w-full h-fit md:my-20 my-10 grid md:px-10  md:grid-cols-[65%_35%] grid-cols-1 justify-center ">
                <div className="flex  items-center  ">
                    <h1 className="xl:text-5xl/relaxed lg:text-4xl/relaxed  text-3xl/relaxed  font-medium text-foreground  tracking-tight md:px-4 font-poppins">Mors Alfabesi Çeviri <br></br> <span className="bg-gradient-to-r from-green-500 to-teal-900 text-transparent bg-clip-text">Anında Dönüştürün & Çözün</span></h1>
                </div>
                <div className=" flex-col flex justify-center h-full px-2 mt-4 md:mt-0 ">
                    <div className="my-4">
                        <p className="text-foreground tracking-tight w-[100%] font-medium text-justify  text-lg font-maitree ">Ücretsiz Mors Alfabesi Çeviri aracımızla Türkçeyi anında mors koduna çevirin veya mors kodunu çözün. Sesli oynatma ve paylaşım seçenekleriyle kolayca mors sinyalleri üretin, dönüştürün ve okuyun.
                        </p>
                    </div>

                    <div className="my-4">
                        <button>
                            <a href="#converter" className="bg-primary mr-6 text-primary-foreground px-4 py-2 rounded-lg font-poppins hover:opacity-90">Başlat</a>
                            <a href="#converter" className="bg-primary text-primary-foreground px-4 py-2 rounded-lg font-poppins hover:opacity-90">Mağaza</a>
                        </button>
                    </div>
                </div>
            </div>
