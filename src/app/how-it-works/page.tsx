    ...
    <main className="bg-[rgb(236,232,228)] w-[98%] mx-auto p-4 md:px-10 rounded-lg rounded-b-none h-fit flex flex-col">
      ...
      <div className="max-w-5xl mx-auto w-full py-8 md:py-12">
        ...
        <div className="text-[#372824]">
          ...
          <ul className="mb-4">
            <li className="text-[#2d2d2d] list-disc md:ml-10 ml-6 my-2 font-maitree text-lg/relaxed font-extralight">Language toggling (where supported)</li>
            <li className="text-[#2d2d2d] list-disc md:ml-10 ml-6 my-2 font-maitree text-lg/relaxed font-extralight">Copy to clipboard button</li>
            <li className="text-[#2d2d2d] list-disc md:ml-10 ml-6 my-2 font-maitree text-lg/relaxed font-extralight">Real-time conversion</li>
          </ul>
        </div>
      </div>
    </main>
