        ...
        <div className="hero bg-background w-[98%] mx-auto p-4 md:px-10 rounded-lg rounded-b-none  h-fit flex flex-col ">
            <div className="w-full h-fit md:my-20 my-10 grid md:px-10  md:grid-cols-[65%_35%] grid-cols-1 justify-center ">
                <div className="flex  items-center  ">
                    <h1 className="xl:text-5xl/relaxed lg:text-4xl/relaxed  text-3xl/relaxed  font-medium text-foreground  tracking-tight md:px-4 font-poppins">Código Morse Traductor <br></br> <span className="bg-gradient-to-r from-green-500 to-teal-900 text-transparent bg-clip-text">Convierte & Decodifica Instantáneamente.</span></h1>
                </div>
                <div className=" flex-col flex justify-center h-full px-2 mt-4 md:mt-0 ">
                    <div className="my-4">
                        <p className="text-foreground tracking-tight w-[100%] font-medium text-justify  text-lg font-maitree ">Traduce texto en español a código Morse y viceversa con nuestro traductor gratuito de código Morse. Convierte, decodifica y genera señales Morse fácilmente con reproducción de audio y opciones para compartir.
                        </p>
                    </div>

                    <div className="my-4">
                        <button>
                            <a href="#converter" className="bg-primary mr-6 text-primary-foreground px-4 py-2 rounded-lg font-poppins hover:opacity-90">Empezar</a>
                            <a href="#converter" className="bg-primary text-primary-foreground px-4 py-2 rounded-lg font-poppins hover:opacity-90">Visitar Tienda</a>
                        </button>
                    </div>
                </div>
            </div>
    ...
    const features = [
        {
            ...
            description: "Traduce con precisión del español al código Morse internacional y viceversa.",
        ...
        },
        {
            ...
            description: "Traduce con precisión del español al código Morse americano y viceversa.",
        ...
        },
        {
            ...
            description: "Convierta instantáneamente la escritura a código Morse. La velocidad del Morse es configurable y puede ser pitidos, una luz intermitente o vibración.",
