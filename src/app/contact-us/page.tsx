    ...
    <main className="bg-background w-[98%] mx-auto p-4 md:px-10 rounded-lg rounded-b-none h-fit flex flex-col">
      ...
      <div className="max-w-5xl mx-auto w-full py-8 md:py-12">
        ...
        <div className="text-foreground">
          ...
          <ul className="mb-4">
            <li className="text-foreground list-disc md:ml-10 ml-6 my-2 font-maitree text-lg/relaxed font-extralight">Feedback or bug reports</li>
            <li className="text-foreground list-disc md:ml-10 ml-6 my-2 font-maitree text-lg/relaxed font-extralight">Collaboration opportunities</li>
            <li className="text-foreground list-disc md:ml-10 ml-6 my-2 font-maitree text-lg/relaxed font-extralight">Language support suggestions</li>
            <li className="text-foreground list-disc md:ml-10 ml-6 my-2 font-maitree text-lg/relaxed font-extralight">General inquiries</li>
          </ul>

          <h2 className="md:text-2xl/relaxed text-xl/relaxed text-foreground font-medium my-6">📧 Email</h2>
          <p className="mt-2 font-maitree text-foreground md:ml-4 ml-2 text-lg/relaxed font-extralight mb-4">
