        ...
        <div className="hero bg-[rgb(236,232,228)] w-[98%] mx-auto p-4 md:px-10 rounded-lg rounded-b-none  h-fit flex flex-col ">
            <div className="w-full h-fit my-20  grid md:px-10  md:grid-cols-[65%_35%] grid-cols-1 justify-center ">
                ...
                <div className=" flex-col flex justify-center h-full px-2 mt-10 md:mt-0 ">
                    <div className="my-4">
                        <p className="text-[#6c6860] tracking-tight w-[100%] font-medium text-justify  text-lg font-maitree ">Translate English to Morse code and vice versa instantly with our free Morse Code Translator. Convert, decode, and generate Morse signals easily with audio playback and sharing options.
                        </p>
                    </div>
            ...
            <div className="editor-container  w-[98%] md:px-4 mx-auto h-fit flex justify-center items-center ">
                <div className="editor-window w-full h-full bg-white rounded-lg shadow-lg">
                    <MorseConverter initialText={""} textToMorse={false}/>
                </div>
            </div>
        </div>
    );
