    ...
    <main className="bg-background w-[98%] mx-auto p-4 md:px-10 rounded-lg rounded-b-none h-fit flex flex-col">
      ...
      <div className="max-w-5xl mx-auto w-full py-8 md:py-12">
        ...
        <div className="text-foreground">
          ...
          <h2 className="md:text-2xl/relaxed text-xl/relaxed text-foreground font-medium mt-6 mb-3">🔹 What is Morse code?</h2>
          ...
          <h2 className="md:text-2xl/relaxed text-xl/relaxed text-foreground font-medium mt-6 mb-3">🔹 How do I use Morsecodeholistic?</h2>
          <p className="mt-2 font-maitree text-foreground md:ml-4 ml-2 text-lg/relaxed font-extralight mb-4">
          ...
          <h2 className="md:text-2xl/relaxed text-xl/relaxed text-foreground font-medium mt-6 mb-3">🔹 Does this tool support non-English languages?</h2>
          <p className="mt-2 font-maitree text-foreground md:ml-4 ml-2 text-lg/relaxed font-extralight mb-4">
          ...
          <h2 className="md:text-2xl/relaxed text-xl/relaxed text-foreground font-medium mt-6 mb-3">🔹 Can I use this tool offline?</h2>
          <p className="mt-2 font-maitree text-foreground md:ml-4 ml-2 text-lg/relaxed font-extralight mb-4">
            Currently, Morsecodeholistic is web-based. We may consider adding offline functionality or a mobile app in the future.
          </p>

          <h2 className="md:text-2xl/relaxed text-xl/relaxed text-foreground font-medium mt-6 mb-3">🔹 Is this tool free to use?</h2>
          <p className="mt-2 font-maitree text-foreground md:ml-4 ml-2 text-lg/relaxed font-extralight mb-4">
            Absolutely! Our goal is to make Morse code accessible for everyone. No fees or sign-ups required.
          </p>

          <h2 className="md:text-2xl/relaxed text-xl/relaxed text-foreground font-medium mt-6 mb-3">🔹 Is my data safe?</h2>
          <p className="mt-2 font-maitree text-foreground md:ml-4 ml-2 text-lg/relaxed font-extralight mb-4">
