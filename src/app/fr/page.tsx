        ...
        <div className="hero bg-[rgb(236,232,228)] w-[98%] mx-auto p-4 md:px-10 rounded-lg rounded-b-none  h-fit flex flex-col ">
            <div className="w-full h-fit md:my-20 my-10 grid md:px-10  md:grid-cols-[65%_35%] grid-cols-1 justify-center ">
                <div className="flex  items-center  ">
                    <h1 className="xl:text-5xl/relaxed lg:text-4xl/relaxed  text-3xl/relaxed  font-medium text-[#2d2d2d]  tracking-tight md:px-4 font-poppins">Traducteur de Code Morse <br></br> <span className="bg-gradient-to-r from-green-500 to-teal-900 text-transparent bg-clip-text">Convertissez & Décodez Instantanément.</span></h1>
                </div>
                <div className=" flex-col flex justify-center h-full px-2 mt-4 md:mt-0 ">
                    <div className="my-4">
                        <p className="text-[#2d2d2d] tracking-tight w-[100%] font-medium text-justify  text-lg font-maitree ">Traduisez instantanément l`&apos;`anglais en code Morse et inversement avec notre traducteur morse gratuit. Convertissez, décodez et générez des signaux Morse facilement, avec lecture audio et options de partage.
                        </p>
                    </div>

                    <div className="my-4">
                        <button>
                            <a href="#converter" className="bg-[#456359] mr-6 text-white px-4 py-2 rounded-lg font-poppins hover:bg-[#324740]">Commencer</a>
                            <a href="#converter" className="bg-[#456359] text-white px-4 py-2 rounded-lg font-poppins hover:bg-[#324740]">Visiter la Boutique</a>
                        </button>
                    </div>
                </div>
            </div>
    ...
    const features = [
        {
            ...
            description: "Traduisez précisément l'anglais vers le code Morse international et inversement.",
        ...
        },
        {
            ...
            description: "Traduisez précisément l'anglais vers le code Morse américain et inversement.",
